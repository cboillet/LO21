...
public:
    ...
    void setupUi(QDialog *UVAddDialog)
    {
        ...
        test->setFont(font);
        layoutWidget = new QWidget(UVAddDialog);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(30, 20, 271, 201));
        ...
        codeLine = new QLineEdit(layoutWidget);
        ...
        nbCreditspinBox = new QSpinBox(layoutWidget);
