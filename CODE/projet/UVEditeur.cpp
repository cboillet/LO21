...
UVEditeurNew::UVEditeurNew(QWidget *parent){
        ...
        //création des composantes de l'UV
        int nbc;
        Categorie cat;
        bool a;
        bool p;
        ...
        categorie->setCurrentIndex(int(cat));
        automne=new QCheckBox("automne",this);
        automne->setChecked(a);
        printemps=new QCheckBox("printemps",this);
        printemps->setChecked(p);
        sauver= new QPushButton("Sauver", this);
        annuler= new QPushButton("Annuler", this);
        //ajouterUV(Manager<UV,UVManager>& man, const QString& c, const QString& t, unsigned int nbc, Categorie cat, bool a, bool p)
